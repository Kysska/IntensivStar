...
class UpcomingMovieRepositoryImpl(private val movieApiInterface: MovieApiInterface, private val movieCardDao: MovieCardDao) :
    ...
    override fun getMoviesFromNetwork(): Single<List<MovieCard>> {
        return fetchMoviesFromNetwork(
            apiCall = { movieApiInterface.getUpcomingMovies() },
            tag = REPOSITORY_TAG
        )
    }
    ...
    companion object {
        const val REPOSITORY_TAG = "UpcomingMovieRepository"
        const val CATEGORY_NAME = "Upcoming"
    }
}
