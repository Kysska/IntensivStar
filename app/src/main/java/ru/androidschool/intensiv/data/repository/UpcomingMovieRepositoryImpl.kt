...
class UpcomingMovieRepositoryImpl(private val movieApiInterface: MovieApiInterface) : BaseRepository(), MovieRepository {

    override fun getMovies(callback: (CustomResult<List<MovieCard>>) -> Unit) {
        handleResponse(
            call = movieApiInterface.getUpcomingMovies(),
